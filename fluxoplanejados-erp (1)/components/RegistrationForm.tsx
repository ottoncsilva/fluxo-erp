  ...
  return (
    <div className="flex-1 overflow-y-auto bg-background-light dark:bg-background-dark p-6">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Content Area */}
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 p-8 animate-fade-in min-h-[500px]">
        ...
        {/* Action Footer */}
        <div className="mt-6 flex justify-between items-center bg-white dark:bg-[#1a2632] p-4 rounded-xl shadow-lg border border-slate-200 dark:border-slate-800 sticky bottom-6 z-20">
            <button 
